...
namespace YourNamespace.Services
{
    public class SapB1Service : ISapB1Service
    {
        ...
        public SapB1Service(IHttpClientFactory clientFactory, IOptions<CompanyConnection> config)
        {
        ...
        public async Task<string> CreateARInvoice(ARInvoiceRequestModel arInvoice)
        {
            ...
            var jsonContent = JsonSerializer.Serialize(arInvoice);
            request.Content = new StringContent(jsonContent, Encoding.UTF8, "application/json");
